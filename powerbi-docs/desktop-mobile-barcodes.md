...
现在当你打开 [iPhone 的 Power BI 应用](mobile-iphone-app-get-started.md)上的扫描器并扫描条形码时，你将在报表列表上看到此报表。 当你打开报表时，将按你扫描的产品条形码筛选报表的视觉对象。
...
* [从你的 iPhone 上的 Power BI 应用中扫描条形码](mobile-apps-scan-barcode-iphone.md)
* [在 iPhone 上扫描条形码时遇到的问题](mobile-apps-scan-barcode-iphone.md#issues-with-scanning-a-barcode)
