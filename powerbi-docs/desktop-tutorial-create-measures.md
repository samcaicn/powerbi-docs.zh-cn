...
**2.** 在编辑栏中选中“Measure”，然后键入“Net Sales”。
...
**4.** 选择“ **Sales[SalesAmount]** ”，然后键入右括号。
...
**2. 现在将“RegionCountryName”字段从“Geography”表拖到图表中。
...
**8.** 单击“2013 年”。 你将看到图表发生更改。 我们的 Net Sales 和 SalesAmount 度量值将进行重新计算，并仅显示 2013 年的新结果。 再次重申，我们已更改了度量值在其中计算和显示结果的上下文。
...
### <a name="net-sales-per-unit"></a>每单位的净销售额
...
**7.** 删除“ProductCategory”字段，然后改为将“ProductName”字段从“Product”表向下拖到“组”区域中。 
