...
### <a name="choose-the-locale-to-be-used-when-importing-data-into-power-bi-desktop"></a>将数据导入 Power BI Desktop 时选择要使用的区域设置
...
2. 在“**当前文件**下，选择“**区域设置**”。
3. 在**区域设置**框中选择不同的区域设置。 
   
   ![Power BI Desktop“选项”对话框](media/supported-languages-countries-regions/pbi_supptdlangs_locale.png)
4. 选择**确定**。
