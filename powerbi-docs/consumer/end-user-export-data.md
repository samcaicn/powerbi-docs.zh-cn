...
ms.locfileid: "48908845"
---
# <a name="export-data-from-visualizations"></a>从可视化效果导出数据
若要查看用于创建可视化效果的数据，可以[在 Power BI 中显示该数据](end-user-show-data.md)或将这些数据以 .xlsx 或.csv 文件形式导出到 Excel。   
...
为此，打开“[编辑视图](end-user-reading-view.md)”中的“[采购分析示例报表](../sample-procurement.md)”。 [添加新的空白报表页](../power-bi-report-add-page.md)。 然后按照以下步骤来添加聚合和可视化效果级别筛选器。
...
选择基础数据时看到的内容可能会有所不同。 如需了解这些内容的详细信息，请联系管理员或 IT 部门获取帮助。 在 Power BI Desktop 或 Power BI 服务中，在报表视图中，带有计算器图标 ![显示图标](./media/end-user-export-data/power-bi-calculator-icon.png) 的字段中将显示一个度量值。 度量值是在 Power BI Desktop 中而不是 Power BI 服务中创建的。
...
[Power BI 中的报表](end-user-reports.md)  
