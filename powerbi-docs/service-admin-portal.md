...
组织中的用户可以从磁贴或可视化效果导出数据。 [了解详细信息](consumer/end-user-export-data.md)
...
转到此处以了解有关[推送应用](consumer/end-user-create-apps.md#how-to-install-an-app-automatically-for-end-users)的详细信息。
